...
val = int(input("Press 1 to Print Truck Route: \nPress 2 to Check a Time:  \n "))
if val == 1:
    ...
    truck2 = []
    truck3 = []
    # create item from Item class, this will be used to check delivery times
    # i = Item()
        ...
        for location1 in list(map.adjacency_list):
            ...
            if location1 == current_address:  # make sure your iteration starts at the last delivered address
                for location2 in list(map.adjacency_list):
                    if map.get_location_name(location1) == map.get_location_name(location2):  # if locations are the same
                        # don't do anything
                        continue
                ...
                # print truck route
                print('from:', location1, ' To:', min_address_name, ' Distance: ', min_distance, "Delivered: ",
    ...
    # Print addresses Truck two has to take
    ...
    package_id_num = input("Enter Package ID's 1-40 to lookup: ")
